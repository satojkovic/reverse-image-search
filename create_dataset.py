...
if __name__ == '__main__':
    ...
    dump('train_image_vecs.pkl', train_image_word_vecs[train_ids])
    dump('val_image_vecs.pkl', train_image_word_vecs[val_ids])
    dump('test_image_vecs.pkl', test_image_word_vecs)
